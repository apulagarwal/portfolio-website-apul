...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Apul Agarwal" },
      { name: "author", content: "Apul Agarwal" },
      ...
      { name: "description", content: "15+ years building defense and homeland security software at scale. UW Foster MBA 2026. Based in Seattle, WA." },
      { property: "og:description", content: "15+ years building defense and homeland security software at scale. UW Foster MBA 2026. Based in Seattle, WA." },
      { name: "twitter:description", content: "15+ years building defense and homeland security software at scale. UW Foster MBA 2026. Based in Seattle, WA." },
