...
export const FALLBACK = {
  ...
  about_p3:
    "Most TPMs in US tech have never deployed software to a field site, managed a vendor across 23 locations simultaneously, or owned a release where a failure had physical consequences. That gap is what I fill. I completed my MBA at UW Foster School of Business in June 2026 and am actively looking for senior TPM or PM (Technical) roles where engineering rigor and program-scale delivery both matter. If that describes a problem you're working on, I'd like to hear about it.",
  work_p1:
